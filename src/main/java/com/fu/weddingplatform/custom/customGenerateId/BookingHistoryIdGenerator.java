...
public class BookingHistoryIdGenerator implements IdentifierGenerator {
  ...
  public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o)
    ...
    if (rs.next()) {
      ...
      return String.format("BOOKING-HISTORY-%d", maxId);

    } else {
      return String.format("BOOKING-HISTORY-%d", count);
    }
  }
}