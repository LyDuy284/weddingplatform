        ...
        public static final String content(EmailCreateBookingToSupplier content) {
                ...
                emailBody.append(
                                "<span style=\"width: 75%; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;\"><b>"
                                                + content.getServiceSupplierName() + "</b></span>");
                emailBody.append("<span style=\"width: 8%; text-align: center;\"><b>" + content.getQuantity()
                                + "</b></span>");
                emailBody.append("<span style=\"width: 17%; text-align: right;\">" + content.getPrice()
                                + "</span></div>");
