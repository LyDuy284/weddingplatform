...
public class TransactionSummaryIdEnerator implements IdentifierGenerator {
  ...
  public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o)
    ...
    if (rs.next()) {
      ...
      return String.format("TRANSACTION-SUMMARY-%d", maxId);

    } else {
      return String.format("TRANSACTION-SUMMARY-%d", count);
    }
  }
}