...
public class RefundMailForSupplier {
  public static final String content(MailRefundForSupplierDTO content) {
    ...
    emailBody.append(
        "<p>Khách hàng: <b style=\"padding-left: 1rem;\">" + content.getCouple().getAccount().getName() + "</b></p>");
    emailBody.append("<p>Số điện thoại: <b style=\"padding-left: 1rem;\">"
        + content.getCouple().getAccount().getPhoneNumber() + "</b></p>");
    ...
    emailBody.append("<div><span style=\"display: inline-block; width: 8rem;\">Phí nền tảng:</span><b><i>"
