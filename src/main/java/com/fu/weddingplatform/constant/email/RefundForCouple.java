...
public class RefundForCouple {
  public static final String content(MailRefundForCoupleDTO content) {
    ...
    emailBody.append("<p><b>The Day</b> xin thông báo tiền đã được hoàn về ví của bạn.</p>");
    emailBody.append(
    ...
    emailBody.append("<p>Nhà cung cấp: <b style=\"padding-left: 1rem;\">" + content.getSupplierName() + "</b></p>");
    ...
    emailBody.append("<div><span style=\"display: inline-block; width: 14rem;\">Tổng tiền đã thanh toán:</span><b><i>"
        + content.getTotalAmount() + "</i></b></div>");
    emailBody.append("<div><span style=\"display: inline-block; width: 14rem;\">Phí hệ thống:</span><b><i>"
        + content.getPlatformAmount() + "</i></b></div>");
    emailBody.append("<div><span style=\"display: inline-block; width: 14rem;\">Phí phạt cho nhà cung cấp:</span><b><i>"
        + content.getSupplierAmount() + "</i></b></div>>");
    emailBody.append("<div><span style=\"display: inline-block; width: 14rem;\">Còn lại:</span><b><i>"
        + content.getReceivedAmount() + "</i></b></div></div>");
    emailBody.append(
        "<p style=\"margin: 0.5rem 0; margin-top: 1.5rem;\">Kiểm tra Ví tại: <a href=\"https://the-day-six.vercel.app/wallet-history\">Tại đây</a></p>");
    emailBody.append(
