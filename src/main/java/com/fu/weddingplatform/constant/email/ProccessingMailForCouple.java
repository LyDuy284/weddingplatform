...
public class ProccessingMailForCouple {
  public static final String content(ProcessingMailForCoupleDTO content) {
    ...
    emailBody.append("<p><b>The Day</b> xin thông báo đơn hàng <b>" + content.getBookingDetail().getId()
        + "</b> được bắt đầu thực hiện bởi <b>" + content.getSupplier().getSupplierName() + "</b>.</p>");
    emailBody.append(
    ...
    emailBody
        .append("<p>SĐT: <b style=\"padding-left: 1rem;\">" + content.getSupplier().getContactPhone() + "</b></p>");
    ...
    emailBody.append("<i style=\"padding-left: 1rem; font-size: 1rem; font-size: 14px;\"><b>"
    ...
    emailBody.append("<div><span style=\"display: inline-block; width: 8rem;\">Còn lại:</span><b><i>"
        + content.getRemainingAmount() + "</i></b></div></div>");
    emailBody.append(
        "<p style=\"margin: 0.5rem 0; margin-top: 1.5rem;\">Kiểm tra trạng thái đơn hàng tại: <a href=\"https://the-day-six.vercel.app/booking-history/" + content.getBookingDetail().getBooking().getId() + "\">Tại đây</a></p>");
    emailBody.append(
