...
public class ServiceSupplierIdGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o)
        ...
        if (rs.next()) {
            ...
            return String.format("SERVICE-SUPPLIER-%d", maxId);

        } else {
            return String.format("SERVICE-SUPPLIER-%d", count);
        }
    }
}