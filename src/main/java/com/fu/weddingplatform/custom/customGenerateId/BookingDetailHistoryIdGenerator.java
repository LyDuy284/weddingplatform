...
public class BookingDetailHistoryIdGenerator implements IdentifierGenerator {
    ...
    public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object o)
        ...
        if (rs.next()) {
            ...
            return String.format("BOOKING-DETAIL-HISTORY-%d", maxId);

        } else {
            return String.format("BOOKING-DETAIL-HISTORY-%d", count);
        }
    }
}